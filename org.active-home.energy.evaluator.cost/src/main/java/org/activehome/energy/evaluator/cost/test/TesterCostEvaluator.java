package org.activehome.energy.evaluator.cost.test;
 ...
 */
@ComponentType
public class TesterCostEvaluator extends ComponentTester {

    @Param(defaultValue = "Mock up to test Cost Evaluator.")
    ...
    public final void onStopTime() {
        super.onStopTime();
        Request evalReq = new Request(getFullId(), getNode() + ".costEval", getCurrentTime(),
